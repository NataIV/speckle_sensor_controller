...
#---- Este es el pin de entrada analogica
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { vauxp6 }]; #IO_L20P_T3_AD6P_35 Sch=JA4_R_P
...
set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { vauxn6 }]; #IO_L20N_T3_AD6N_35 Sch=JA4_R_N
...
# Conexionado al chip:
#
#  PIN        FUNCION           PIN_ZYBO
#   40       amp_reg_in           Abierto      
#   39          amp_rst           VDD
#   38        amp_I_out           BNC
#   37      amp_reg_out            -
#   36          amp_clk           GND
...
#
#
# ----------------------------            SEGUNDA VERSION DE CONEXIONES          ---------------------------------
#                              Pmod (JB)
#                          🔻
#                col_clk -- 1 (T20) (Y18)  7 -- row_clk     
#                col_dat -- 2 (U20) (Y19)  8 -- row_dat
#                col_ena -- 3 (V20) (W18)  9 -- row_ena
#                col_rst -- 4 (W20) (W19) 10 -- row_rst
#                    GND -- 5             11 -- GND
#                    VDD -- 6             12 -- VDD


##Pmod Header JB -> Conexiones al chip
set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33 } [get_ports { o_chip_col_clk   }]; #IO_L15P_T2_DQS_34 Sch=JB1_p
set_property -dict { PACKAGE_PIN U20   IOSTANDARD LVCMOS33 } [get_ports { o_chip_col_data  }]; #IO_L15N_T2_DQS_34 Sch=JB1_N
set_property -dict { PACKAGE_PIN V20   IOSTANDARD LVCMOS33 } [get_ports { o_chip_key_wren  }]; #IO_L16P_T2_34 Sch=JB2_P
set_property -dict { PACKAGE_PIN W20   IOSTANDARD LVCMOS33 } [get_ports { o_chip_col_rst   }]; #IO_L16N_T2_34 Sch=JB2_N
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { o_chip_row_clk   }]; #IO_L17P_T2_34 Sch=JB3_P
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { o_chip_row_data  }]; #IO_L17N_T2_34 Sch=JB3_N
...
##Pmod Header JD -> Copia de las conexiones
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { o_chip_col_clk_cpy   }]; #IO_L5P_T0_34 Sch=JD1_P
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { o_chip_col_data_cpy  }]; #IO_L5N_T0_34 Sch=JD1_N
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { o_chip_key_wren_cpy  }]; #IO_L6P_T0_34 Sch=JD2_P
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { o_chip_col_rst_cpy   }]; #IO_L6N_T0_VREF_34 Sch=JD2_N
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { o_chip_row_clk_cpy   }]; #IO_L11P_T1_SRCC_34 Sch=JD3_P
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { o_chip_row_data_cpy  }]; #IO_L11N_T1_SRCC_34 Sch=JD3_N
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { o_chip_row_ena_cpy   }]; #IO_L21P_T3_DQS_34 Sch=JD4_P
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { o_chip_row_rst_cpy   }]; #IO_L21N_T3_DQS_34 Sch=JD4_N


##Pmod Header JE
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { o_chip_amp_clk_cpy  }]; #IO_L4P_T0_34 Sch=JE1
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { o_chip_amp_data_cpy }]; #IO_L18N_T2_34 Sch=JE2
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { o_chip_amp_ena_cpy  }]; #IO_25_35 Sch=JE3
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { o_chip_amp_rst_cpy  }]; #IO_L19P_T3_35 Sch=JE4
